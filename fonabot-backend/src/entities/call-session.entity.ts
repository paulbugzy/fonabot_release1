...
import { PhoneNumber } from './phone-number.entity'; // Import PhoneNumber - MOVED TO THE TOP
...
export class CallSession {
  ...
  @ManyToOne(() => PhoneNumber, phone => phone.callSessionsTo) // Define the relation based on phoneNumberTo
  @JoinColumn({ name: 'phone_number_to', referencedColumnName: 'phoneNumber' })
