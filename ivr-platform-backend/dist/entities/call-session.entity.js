...
__decorate([
    (0, typeorm_1.ManyToOne)(() => phone_number_entity_1.PhoneNumber, phone => phone.callSessionsTo),
    (0, typeorm_1.JoinColumn)({ name: 'phone_number_to', referencedColumnName: 'phoneNumber' }),
    __metadata("design:type", phone_number_entity_1.PhoneNumber)
], CallSession.prototype, "phoneNumberToRelation", void 0);
