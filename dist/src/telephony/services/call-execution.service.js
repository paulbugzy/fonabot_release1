...
let CallExecutionService = CallExecutionService_1 = class CallExecutionService {
    constructor(callSessionRepository, asrService, nluService, eventsGateway, ivrFlowRepository, callLogEventRepository, credentialsService, ivrFlowRepository, redisService) {
    ...
    async handleAIRoutineNode(session, flow, node, response) {
        ...
        try {
            ...
            }, session.userId, nlu_service_name);
            const updates = {
    ...
    replaceVariables(text, variables) {
        return text.replace(/\{variables\.([^}]+)\}/g, (match, key) => {
            return _.get(variables, key, match);
        });
    }
    ...
    async updateSessionNextNode(session, nextNode, input) {
        ...
        this.eventsGateway.emitCallNodeChanged(session.userId, {
        ...
        if (input) {
            ...
            this.eventsGateway.emitCallInputReceived(session.userId, {
                call_log_id: session.id,
...
exports.CallExecutionService = CallExecutionService = CallExecutionService_1 = __decorate([
    ...
    __param(4, (0, typeorm_1.InjectRepository)(ivr_flow_entity_1.IvrFlow)),
    __param(5, (0, typeorm_1.InjectRepository)(call_log_event_entity_1.CallLogEvent)),
    __metadata("design:paramtypes", [typeorm_2.Repository,
        asr_service_1.ASRService,
        nlu_service_1.NLUService,
        fonabot_events_gateway_1.FonaBotEventsGateway,
        typeorm_2.Repository,
        typeorm_2.Repository, typeof (_a = typeof CredentialsService !== "undefined" && CredentialsService) === "function" ? _a : Object, typeorm_2.Repository,
